...
import com.olivia.api.PlatformDtos.FunnelStage;
import com.olivia.api.PlatformDtos.MetricPoint;
import com.olivia.domain.talent.MatchReadRepository;
...
public class PlatformService {
    ...
    public List<com.olivia.api.PlatformDtos.Integration> integrations() {
        return integrationRepository.findAll().stream()
                .map(
                        i ->
                                new com.olivia.api.PlatformDtos.Integration(
